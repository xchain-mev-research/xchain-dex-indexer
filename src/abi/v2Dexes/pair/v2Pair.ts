...
import { ABI_JSON } from './v2Pair.abi'
...
export const functions = {
    ...
    setDevFee: new Func<[_devFee: number], { _devFee: number }, []>(
        abi, '0x03c150b0'
    ),
    setSwapFee: new Func<[_swapFee: number], { _swapFee: number }, []>(
        abi, '0xd6d788c3'
    ),
...
export class Contract extends ContractBase {
    ...
    swapFee(): Promise<number> {
        return this.eth_call(functions.swapFee, [])
    }
