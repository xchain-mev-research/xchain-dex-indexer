...
import { ABI_JSON } from './v3AlgebraFactory.abi';
...
export const functions = {
    ...
    forbidPause: new Func<[], {}, []>(
        abi, '0xd04a9230'
    ),
    isPauseForbidden: new Func<[], {}, boolean>(
        abi, '0xb48d1cbc'
    ),
...
export class Contract extends ContractBase {
    ...
    isPauseForbidden(): Promise<boolean> {
        return this.eth_call(functions.isPauseForbidden, [])
    }
