...
export const events = {
    CustomPool: event("0x8a5f030f5fc13b04a1e4ef7c47177e3d76b0e80e1d9be9843db37caa5b7b9b8f", "CustomPool(address,address,address,address)", {"deployer": indexed(p.address), "token0": indexed(p.address), "token1": indexed(p.address), "pool": p.address}),
...
export const functions = {
    CUSTOM_POOL_DEPLOYER: viewFun("0x07810754", "CUSTOM_POOL_DEPLOYER()", {}, p.bytes32),
    ...
    computeCustomPoolAddress: viewFun("0x1ba89df4", "computeCustomPoolAddress(address,address,address)", {"deployer": p.address, "token0": p.address, "token1": p.address}, p.address),
    computePoolAddress: viewFun("0xd8ed2241", "computePoolAddress(address,address)", {"token0": p.address, "token1": p.address}, p.address),
    createCustomPool: fun("0xdbbf3db4", "createCustomPool(address,address,address,address,bytes)", {"deployer": p.address, "creator": p.address, "tokenA": p.address, "tokenB": p.address, "data": p.bytes}, p.address),
    createPool: fun("0x321935c6", "createPool(address,address,bytes)", {"tokenA": p.address, "tokenB": p.address, "data": p.bytes}, p.address),
    customPoolByPair: viewFun("0x23da36cc", "customPoolByPair(address,address,address)", {"_0": p.address, "_1": p.address, "_2": p.address}, p.address),
    defaultCommunityFee: viewFun("0x2f8a39dd", "defaultCommunityFee()", {}, p.uint16),
    defaultConfigurationForPool: viewFun("0x25b355d6", "defaultConfigurationForPool()", {}, {"communityFee": p.uint16, "tickSpacing": p.int24, "fee": p.uint16}),
...
export class Contract extends ContractBase {
    ...
    CUSTOM_POOL_DEPLOYER() {
        return this.eth_call(functions.CUSTOM_POOL_DEPLOYER, {})
    }
    ...
    computeCustomPoolAddress(deployer: ComputeCustomPoolAddressParams["deployer"], token0: ComputeCustomPoolAddressParams["token0"], token1: ComputeCustomPoolAddressParams["token1"]) {
        return this.eth_call(functions.computeCustomPoolAddress, {deployer, token0, token1})
    }
    ...
    customPoolByPair(_0: CustomPoolByPairParams["_0"], _1: CustomPoolByPairParams["_1"], _2: CustomPoolByPairParams["_2"]) {
        return this.eth_call(functions.customPoolByPair, {_0, _1, _2})
    }
    ...
    defaultConfigurationForPool() {
        return this.eth_call(functions.defaultConfigurationForPool, {})
    }
...
/// Event types
export type CustomPoolEventArgs = EParams<typeof events.CustomPool>
...
/// Function types
export type CUSTOM_POOL_DEPLOYERParams = FunctionArguments<typeof functions.CUSTOM_POOL_DEPLOYER>
export type CUSTOM_POOL_DEPLOYERReturn = FunctionReturn<typeof functions.CUSTOM_POOL_DEPLOYER>
...
export type ComputeCustomPoolAddressParams = FunctionArguments<typeof functions.computeCustomPoolAddress>
export type ComputeCustomPoolAddressReturn = FunctionReturn<typeof functions.computeCustomPoolAddress>
...
export type CreateCustomPoolParams = FunctionArguments<typeof functions.createCustomPool>
export type CreateCustomPoolReturn = FunctionReturn<typeof functions.createCustomPool>
...
export type CustomPoolByPairParams = FunctionArguments<typeof functions.customPoolByPair>
export type CustomPoolByPairReturn = FunctionReturn<typeof functions.customPoolByPair>
