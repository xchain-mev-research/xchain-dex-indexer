...
export const events = {
    Burn: event("0x932214d4a69c27c086643126ed97c32681da179064c678836c173f99bd13ca01", "Burn(address,int24,int24,uint128,uint256,uint256,uint24)", {"owner": indexed(p.address), "bottomTick": indexed(p.int24), "topTick": indexed(p.int24), "liquidityAmount": p.uint128, "amount0": p.uint256, "amount1": p.uint256, "pluginFee": p.uint24}),
    ...
    ExcessTokens: event("0xef10ebb00f0dbc72ad4602e94abbbda6f3d40632714f70e9c8fa30d5d44289c9", "ExcessTokens(uint256,uint256)", {"amount0": p.uint256, "amount1": p.uint256}),
    ...
    Skim: event("0xb94331e4420f16b156f53c397a8adcd09481283ee7830f7b688b22858e9db80b", "Skim(address,uint256,uint256)", {"to": indexed(p.address), "amount0": p.uint256, "amount1": p.uint256}),
    Swap: event("0x121cb44ee54098b1a04743c487e7460d8dd429b27f88b1f4d4767396e1a59f79", "Swap(address,address,int256,int256,uint160,uint128,int24,uint24,uint24)", {"sender": indexed(p.address), "recipient": indexed(p.address), "amount0": p.int256, "amount1": p.int256, "price": p.uint160, "liquidity": p.uint128, "tick": p.int24, "overrideFee": p.uint24, "pluginFee": p.uint24}),
...
export const functions = {
    ...
    getPluginFeePending: viewFun("0xa1eded87", "getPluginFeePending()", {}, {"_0": p.uint128, "_1": p.uint128}),
    ...
    lastFeeTransferTimestamp: viewFun("0x77f8c3a9", "lastFeeTransferTimestamp()", {}, p.uint32),
...
export class Contract extends ContractBase {
    ...
    getPluginFeePending() {
        return this.eth_call(functions.getPluginFeePending, {})
    }
    ...
    lastFeeTransferTimestamp() {
        return this.eth_call(functions.lastFeeTransferTimestamp, {})
    }
...
export type ExcessTokensEventArgs = EParams<typeof events.ExcessTokens>
...
export type GetPluginFeePendingParams = FunctionArguments<typeof functions.getPluginFeePending>
export type GetPluginFeePendingReturn = FunctionReturn<typeof functions.getPluginFeePending>
...
export type LastFeeTransferTimestampParams = FunctionArguments<typeof functions.lastFeeTransferTimestamp>
export type LastFeeTransferTimestampReturn = FunctionReturn<typeof functions.lastFeeTransferTimestamp>
