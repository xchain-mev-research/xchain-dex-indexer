...
import * as factoryAbi from '@abi/v3Dexes/uniswap/factory/v3UniswapFactory';
...
export function createV3EvmProcessor(dexConfig: DexConfig, fromBlock: number, toBlock: number) {
    ...
    const processor = new EvmBatchProcessor()
        ...
        .addLog({
            ...
            topic0: [
                ...
                poolAbi.events.SetFeeProtocol.topic,
            ],
            transaction: true,
        })
        ;
