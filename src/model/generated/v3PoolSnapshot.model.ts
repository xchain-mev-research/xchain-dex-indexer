...
import {V3PoolSnapshotTick} from "./v3PoolSnapshotTick.model"

@Entity_()
export class V3PoolSnapshot {
    constructor(props?: Partial<V3PoolSnapshot>) {
    ...
    @Index_()
    @ManyToOne_(() => V3Pool, {nullable: true})
    pool!: V3Pool
    ...
    @OneToMany_(() => V3PoolSnapshotTick, e => e.poolSnapshot)
    ticks!: V3PoolSnapshotTick[]
}
